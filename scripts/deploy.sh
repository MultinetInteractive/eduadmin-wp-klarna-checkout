...
PLUGIN="eduadmin-booking-klarna-checkout"
PROJECT_ROOT=$TRAVIS_BUILD_DIR
VERSION="$(cat $PROJECT_ROOT/eduadmin-wp-klarna-checkout.php | grep Version: | head -1 | cut -d: -f2 | tr -d '[[:space:]]')"
...
--data '{"username": "Travis CI", "channel":"#wordpress-eduadmin", "icon_url": "https://a.slack-edge.com/0180/img/services/travis_48.png","text": "EduAdmin Klarna plugin version '"$VERSION"' deployed to <https://wordpress.org/plugins/eduadmin-booking-klarna-checkout/|wp.org> :tada:"}' \
$SLACK_HOOKURL
